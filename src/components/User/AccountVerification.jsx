...
const AccountVerifiedComponent = () => {
    ...
    //useEffect for automatically verifying the account
    useEffect(() => {
    ...
    return (
        <div>
            {mutation?.isPending ? <AlertMessage type="loading" message="Verifying your account..." />
                : mutation?.isError ? <AlertMessage type="error" message="Account Verification Failed, Please Try Again. If you it's a bug please refresh the page." />
                    : mutation?.isSuccess && <div
